...
const SignUpPage = () => {
  return (
    <div className="bg-gradient-to-br from-[#9C668F] via-[#6E4662] to-[#362130]  min-h-screen w-full flex flex-col  justify-center items-center ">
      ...
      <div className="text-center flex flex-col justify-center items-center flex-grow mt-12">
        ...
        <span className="text-[#362130] text-lg font-bold ">
          No more paper chaos or lost files.
        </span>
      </div>

      <div className="flex flex-col sm:flex-row justify-center sm:gap-40 gap-4 items-center">
        <SignUp />
        <img src={womenAtDesk} alt="Woken at Desk" className="mb-[100px]" />
      </div>
    </div>
  );
};
